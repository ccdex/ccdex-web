module.exports = {
    ...
    section1: {
        label1: 'The world’s first cross-chain decentralized exchange platform',
    ...
    section3:{
        title:'	Decentralized cross-chain protocol',
        label1:'Technical characteristics',
    ...
    section4:{
        title:'Distributed memory matching engine',
        label1:'Technical characteristics',
    ...
    section5:{
        title:'Transaction liquidity sharing mechanism between Exchanges',
        label1:'Technical characteristic',
        label1_des1:'Sharing order pool between Exchanges',
