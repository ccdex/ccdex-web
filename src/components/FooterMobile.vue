<template>
    <section class = "footer-mobile">
        ...
        <a href="https://twitter.com/@CCDEX_TOP" target="_blank"><img src="../assets/twitter.svg" alt=""></a>
        ...
        <a href="https://www.jianshu.com/u/27eb10f2f410" target="_blank"><img src="../assets/blog.svg" alt=""></a>
...
.footer-mobile {
  ...
  overflow: hidden;
  .imgs {
    margin: toRem(125) auto toRem(88) auto;
    img {
      width: toRem(124);
      height: toRem(124);
